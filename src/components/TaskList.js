        ...
        <div className="max-w-full mx-auto my-8 px-2 sm:px-4">
            <div className="bg-white shadow-xl rounded-xl overflow-hidden">
                <table className="w-full leading-normal">
                    <thead>
                        <tr>
                            <th className="px-2 py-3 border-b-2 border-gray-200 bg-gray-200 text-left text-xs font-bold text-gray-600 uppercase tracking-wider sm:px-5 sm:py-3">
                                Task
                            </th>
                            <th className="px-2 py-3 border-b-2 border-gray-200 bg-gray-200 text-left text-xs font-bold text-gray-600 uppercase tracking-wider sm:px-5 sm:py-3">
                                Status
                                ...
                                <td className="px-2 py-4 border-b border-gray-200 bg-white text-sm sm:px-5">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div className={`text-xs font-semibold text-gray-600 ${task.completed ? 'line-through' : ''}`}>{task.description}</div>
                                        </div>
                                    </div>
                                </td>
                                <td className="px-2 py-4 border-b border-gray-200 bg-white text-sm sm:px-5">
                                    <span className={`relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight ${task.completed ? 'text-green-500' : 'text-blue-700'}`}>
